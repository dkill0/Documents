...
include("head.php");
?>
<a href="<?php echo $base_home; ?>administracion.php">Administracion</a> > Ingresos
<div id="leftA">
...
<?php
    ...
    $tblDemo = new ajaxCRUD("Item", "ingresos", "idIngreso");
    ...
    $tblDemo->displayAs("cantidadIngreso", "Nombre Pelicula");
    $tblDemo->displayAs("tipoIngreso", "Ficha Pelicula");
    $tblDemo->displayAs("fechaIngreso", "Sinopsis Pelicula");
    $tblDemo->displayAs("idUsuario", "Identificador Video");
