...
include("head.php");
?>
<a href="<?php echo $base_home; ?>administracion.php">Administracion</a> > Series
<div id="leftA">
...
<?php
    ...
    $tblDemo = new ajaxCRUD("Item", "series", "idSerie");
    ...
    $tblDemo->displayAs("nomSerie", "Nombre Serie");
    $tblDemo->displayAs("fichaSerie", "Ficha Serie");
    $tblDemo->displayAs("sinopsisSerie", "Sinopsis Serie");

    $tblDemo->setTextareaHeight('fichaSerie', 100);
    $tblDemo->setTextareaHeight('sinopsisSerie', 100);
    ...
    $tblDemo->addAjaxFilterBox('nomSerie');
