...
include("head.php");
?>
<a href="<?php echo $base_home; ?>administracion.php">Administracion</a> > Peliculas
<div id="leftA">
...
<?php
    ...
    $tblDemo = new ajaxCRUD("Item", "peliculas", "idPelicula");
    ...
    $tblDemo->setTextareaHeight('fichaPelicula', 100);
    $tblDemo->setTextareaHeight('sinopsisPelicula', 100);
